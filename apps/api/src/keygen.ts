 ...
 *
 *   npm run keygen -w @bles/api
 *
 * The private key is what BLES_EVIDENCE_SIGNING_KEY holds -- keep it
 ...
 * anything.
 */
import { exportPrivateKeyBase64, exportPublicKeyBase64, generateEvidenceSigningKeyPair } from "@bles/core";

const { privateKey, publicKey } = generateEvidenceSigningKeyPair();

console.log("# Add this to your .env -- keep it secret:");
console.log(`BLES_EVIDENCE_SIGNING_KEY="${exportPrivateKeyBase64(privateKey)}"`);
console.log();
