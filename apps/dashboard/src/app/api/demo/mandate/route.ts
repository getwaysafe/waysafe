 ...
 * provisions its x402 instrument. Everything here is a real call against
 * the running Waysafe API -- see the imported modules' own doc comments
 * for exactly which parts are real compilation versus infrastructure
 * config (merchant identity) that natural language could never state.
 */
