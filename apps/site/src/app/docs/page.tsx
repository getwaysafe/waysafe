    ...
    <div className="section-light section">
      <div className="container">
        ...
        <p style={{ fontSize: "1.05rem", maxWidth: 700, lineHeight: 1.7 }}>
          Enforcement is rail-initiated: the rail asks Waysafe before money moves, and the agent
          never has to. The SDK below is a <em>preflight</em> — useful, never the thing that stops
          a payment. Start with the enforcement endpoints.
        </p>
        ...
        <p style={{ maxWidth: 700 }}>
          ...
          SDK below. Shapes are transcribed from <code>apps/api/src/server.ts</code>,{" "}
...
{ "approved": true, "reason_codes": ["ALLOW_WITHIN_MANDATE"] }`}</pre>
        ...
        <div className="card" style={{ marginTop: 8, marginBottom: 16, background: "#fff8e1", borderColor: "#f0c96b" }}>
          <p style={{ margin: 0 }}>
            ...
            provisioning of the test-mode account.
          </p>
        </div>
