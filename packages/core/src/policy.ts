...
export const AccountingSchema = z.object({
  ...
  /**
   * `authorization` counts spend when Waysafe authorizes it — conservative,
 ...
 * fulfillment — "refundable", "nonstop". Waysafe cannot independently verify
